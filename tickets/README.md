...
| [`T016`](backlog/T016-implement-web-conversion-and-verification.md) | Implement Web UI: Convert & Verification | `READY` | Full-Stack TypeScript Engineer | `T015` | Build 1-click Convert action bar, code comparison badges, and Loom verification modal. |
