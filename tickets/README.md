...
| [`T022`](active/T022-author-solution-summary-and-loom-prep.md) | Author Solution Summary & Loom Prep | `IN_PROGRESS` | Project / Delivery Manager | `T020`, `T021` | Author `docs/08-solution-summary.md` and `docs/09-loom-walkthrough-outline.md`, and conduct final audit. |
