...
| [`T013`](active/T013-implement-application-use-cases.md) | Implement Application Use Cases | `IN_PROGRESS` | Full-Stack TypeScript Engineer | `T012` | Implement `Resolve`, `Create`, and `Convert` composition with 100% unit test coverage. |
