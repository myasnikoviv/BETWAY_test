...
| [`T017`](active/T017-bootstrap-flutter-gateway-and-di.md) | Bootstrap Flutter Gateway & DI | `IN_PROGRESS` | Flutter Engineer | `T014` | Init Flutter app, configure Dio + Retrofit, define `SlipGateway`, and wire `GetIt` DI. |
