...
| [`T019`](backlog/T019-implement-flutter-slip-viewer-screen.md) | Implement Flutter Slip Viewer Screen | `READY` | Flutter Engineer | `T018` | Build `SlipViewerScreen` and decomposed widgets with widget tests covering all states. |
