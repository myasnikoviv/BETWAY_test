...
| [`T021`](active/T021-build-android-apk-and-firebase-distribution.md) | Build Android APK & Complete Firebase App Distribution Upload | `IN_PROGRESS` | Flutter Engineer | `T019`, `T020` | Build release APK, upload to Firebase App Distribution, and author iOS distribution note. |
| [`T022`](backlog/T022-author-solution-summary-and-loom-prep.md) | Author Solution Summary & Loom Prep | `READY` | Project / Delivery Manager | `T020`, `T021` | Author `docs/08-solution-summary.md` and `docs/09-loom-walkthrough-outline.md`, and conduct final audit. |
