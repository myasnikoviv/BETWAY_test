...
| [`T018`](backlog/T018-implement-flutter-cubit-and-state.md) | Implement Flutter Cubit & State | `READY` | Flutter Engineer | `T017` | Implement `SlipCubit` and `SlipState` with `bloc_test` unit coverage against mocked gateway. |
