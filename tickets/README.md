...
| [`T015`](backlog/T015-implement-web-input-and-slip-view.md) | Implement Web UI: Input & Slip View | `READY` | Full-Stack TypeScript Engineer | `T014` | Build Next.js React UI components for entering codes, decoding, and rendering `BetSlipCard`. |
