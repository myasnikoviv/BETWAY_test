...
| [`T021`](active/T021-build-android-apk-and-firebase-distribution.md) | Build Android APK & Firebase Distribution | `IN_PROGRESS` | Flutter Engineer | `T019`, `T020` | Build release APK, setup Firebase App Distribution, and author `docs/07-ios-ipa-distribution.md`. |
