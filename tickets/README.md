...
| [`T014`](active/T014-implement-backend-api-routes.md) | Implement Backend API Route Handlers | `IN_PROGRESS` | Full-Stack TypeScript Engineer | `T013` | Implement `/api/v1/resolve`, `create`, `convert`, `health` with Zod validation and CORS. |
