...
| [`T015`](active/T015-implement-web-input-and-slip-view.md) | Implement Web UI: Input & Slip View | `IN_PROGRESS` | Full-Stack TypeScript Engineer | `T014` | Build Next.js React UI components for entering codes, decoding, and rendering `BetSlipCard`. |
...
| [`T017`](backlog/T017-bootstrap-flutter-gateway-and-di.md) | Bootstrap Flutter Gateway & DI | `BACKLOG` | Flutter Engineer | `T014` | Init Flutter app, configure Dio + Retrofit, define `SlipGateway`, and wire `GetIt` DI. |
